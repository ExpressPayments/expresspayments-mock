...
func TestCheckConflictingOptions(t *testing.T) {
	...
	{
		options := getDefaultOptions()
		options.httpUnixSocket = "/tmp/expresspayments-mock.sock"
		options.httpsUnixSocket = "/tmp/expresspayments-mock-secure.sock"
...

	{
		options := getDefaultOptions()
		options.port = 12111
		options.unixSocket = "/tmp/expresspayments-mock.sock"
...

	{
		options := getDefaultOptions()
		options.https = true
		options.httpsUnixSocket = "/tmp/expresspayments-mock.sock"
