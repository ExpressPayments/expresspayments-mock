...
import (
	...
	"github.com/expresspayments/expresspayments-mock/param/form"
	"github.com/expresspayments/expresspayments-mock/param/nestedtypeassembler"
	"github.com/expresspayments/expresspayments-mock/param/parser"
)
...
// the ExpressPayments API decodes data. These complex types are what makes the param
...
func ParseParams(r *http.Request) (map[string]interface{}, error) {
	...
	// request body for others, but the way ExpressPayments' API actually works is to
