...
type Info struct {
	// Version is the expresspayments API version represented in the specification. It
...
// then we'll get an error so we remember to update expresspayments-mock to support it.
var supportedSchemaFields = []string{
	...
	"x-expresspaymentsResource",
	"x-expresspaymentsOperations",
	"x-expresspaymentsParam",
	"x-expresspaymentsEvent",
	...
	// expresspayments-mock, we may need to observe this as well.
	"x-expresspaymentsBypassValidation",
}
